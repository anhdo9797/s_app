import 'package:s_app/data/local/local.dart';
...
class AppPref {
  ...
  static bool get isInitDb =>
      _prefInstance?.getBool(StorageString.initDBSuccess) ?? false;
  static set isInitDb(bool value) =>
      _prefInstance?.setBool(StorageString.initDBSuccess, value) ?? false;
}
